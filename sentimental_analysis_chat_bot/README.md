...
```
.
├── FAIFinalCode.ipynb          # Main notebook: LSTM + Random Forest + GUI
├── FAI_FinalReport.pdf         # Full project report (abstract, methodology, results)
├── FAIPPT.pptx                 # Project presentation slides
├── review_data(Sheet1).csv     # Amazon Electronics reviews dataset (10,000 rows)
├── DatasetDetails.txt          # Dataset description & source
└── README.md
```
